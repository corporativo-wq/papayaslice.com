...
LD_HOME=json.dumps({
 "@context":"https://schema.org","@graph":[
  ...
  {"@type":"Restaurant","@id":D+"/#av38","name":"Papaya Slice · Av. 38","url":D+"/","image":D+"/og.jpg","telephone":"+52 984 803 5648","priceRange":"$$","servesCuisine":["Pizza","Italiana"],"menu":D+"/menu","acceptsReservations":"True","parentOrganization":{"@id":D+"/#org"},
  ...
  {"@type":"Restaurant","@id":D+"/#nader","name":"Papaya Slice · Náder","url":D+"/","image":D+"/og.jpg","telephone":"+52 998 174 6115","priceRange":"$$","servesCuisine":["Pizza","Italiana"],"menu":D+"/menu","acceptsReservations":"True","parentOrganization":{"@id":D+"/#org"},
...
ext_images('index.html'); ext_images('menu.html')
